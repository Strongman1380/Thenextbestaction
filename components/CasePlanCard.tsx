          ...
          <div className="bg-gray-50/90 p-4 sm:p-6 rounded-2xl border border-gray-200/80 shadow-sm">
            <ReactMarkdown
              components={{
                ...
                ul: ({ ...props }) => (
                  <ul className="list-disc ml-6 mb-4 space-y-3" {...props} />
                ),
                ol: ({ ...props }) => (
                  <ol className="list-decimal ml-6 mb-4 space-y-3" {...props} />
                ),
                li: ({ ...props }) => (
                  <li className="text-gray-700 leading-relaxed mb-2" {...props} />
                ),
                p: ({ ...props }) => (
